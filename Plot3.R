...
## create the line graph
        ...
        with(h_power_consn, plot(Time2, Sub_metering_1, type = "l", col = "grey40", xlab = "", ylab = "Energy sub metering"))
        
        with(h_power_consn, lines(Time2, Sub_metering_2, type = "l", col = "red", xlab = "", ylab = ""))
        
        with(h_power_consn, lines(Time2, Sub_metering_3, type = "l", col = "blue", xlab = "", ylab = ""))
